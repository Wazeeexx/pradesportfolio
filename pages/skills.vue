                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 flex justify-center">
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400">
                            ...
                            <span class="p-2 text-sm text-white md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">HTML</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 ">
                        ...
                        <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">CSS</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">Vue.js</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">Nuxt.js</span>
                            </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400">
                           <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 256 384"><path fill="#0ACF83" d="M64 384c35.328 0 64-28.672 64-64v-64H64c-35.328 0-64 28.672-64 64s28.672 64 64 64Z"/><path fill="#A259FF" d="M0 192c0-35.328 28.672-64 64-64h64v128H64c-35.328 0-64-28.672-64-64Z"/><path fill="#F24E1E" d="M0 64C0 28.672 28.672 0 64 0h64v128H64C28.672 128 0 99.328 0 64Z"/><path fill="#FF7262" d="M128 0h64c35.328 0 64 28.672 64 64s-28.672 64-64 64h-64V0Z"/><path fill="#1ABCFE" d="M256 192c0 35.328-28.672 64-64 64s-64-28.672-64-64s28.672-64 64-64s64 28.672 64 64Z"/></svg>
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">Figma</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">Tailwind CSS</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">JavaScript</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 shadow ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400 ">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">ReactJs</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 shadow ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400 ">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">Gitlab</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 shadow ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400 ">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">GitHub</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 shadow ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400 ">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">Git</span>
                        </div>
                    </button>
                    ...
                    <button class="col-span-1 md:col-span-2 lg:col-span-1 shadow ">
                        <div class="rounded-lg px-2 py-4 flex items-center shadow shadow-gray-400 ">
                            ...
                            <span class="p-2 text-sm text-white  md:text-base lg:text-sm font-semibold" style="font-family: 'Poppins';">TypeScript</span>
                        </div>
                    </button>
                </div>  
            </div>
