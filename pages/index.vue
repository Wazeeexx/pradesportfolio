              ...
              <div class="flex-cols cols-span-2 flex-col sm:flex-row items-center flex justify-center sm:justify-between mt-16">
                <section id="home" class="mb-8 sm:mr-4">
                  ...
                  <div class="flex flex-col items-center mt-6">
                    <a href="https://drive.google.com/drive/folders/1oSNrJauek5emIjKgUi377Bz-s5wM_2rP"  class="text-black-500 mr-60 inline-flex px-6 py-2 bg-gray-500 text-black rounded-lg mb-4 md:mb-18 font-bold hover:bg-gray-600"
