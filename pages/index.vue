            ...
            <section id="home" class="mb-8 sm:mr-4">
              <div class="mt-4">
                ...
                <div class="mt-4 md:mt-8">
                    <h1 class="text-xl md:text-4xl text-white font-semibold font-poppins">Transforming Ideas Into <br class="md:hidden"> Functional Websites.</h1>
                    <h2 class="text-lg md:text-3xl font-bold font-semibold font-poppins" style="color: #66fcf1; "  ref="typewriter" ><span class="cursor" ></span></h2>
...
//Type writer Effect in Front End Developer
  mounted() {
    ...
    const loopDelay = 50; // Delay before starting the typewriter loop
