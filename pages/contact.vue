<template>
    <div class="bg-black"> 
      ...
      <section id="contact" class="py-12 h-screen" style="margin-left: 30px; margin-right: 30px;">
        ...
        <div class="contact-info-container grid grid-cols-3 gap-6 mt-6">
          <div class="flex flex-col sm:flex-row w-full sm:w-80 bg-black  border shadow-md sm:py-4 items-center sm:items-start hover:bg-gray-500" >
            <a class="p-4 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mb-4 sm:mb-0 sm:mr-4 ml-4 mt-4" style="background-color: #66fcf1;">
