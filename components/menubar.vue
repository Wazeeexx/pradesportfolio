<template>
    <div>
        <div class="container mx-auto flex justify-between items-center">
            ...
            <!-- <img class="w-14 h-14 md:w-18 md:h-18" src="@/assets/img/logo.png" alt="Logo"> -->
            </NuxtLink>
              <!-- <nav class="hidden md:flex space-x-10 font-medium font-poppins pt-4">
                <NuxtLink to="/#" a href="#" class="text-white pt-4 ml-4 transition hover:text-blue-300 hover:underline">Home</NuxtLink>
        ...
        <div class="dropdown">
            <button v-on:click="showNavigation = !showNavigation" class="p-2 mt-4 text-white fixed top-0 right-0 z-50 ml-6 md:hidden">
            <svg class="ml-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="#66fcf1" fill-rule="evenodd" d="M3.5 5a1 1 0 0 0 0 2h17a1 1 0 1 0 0-2h-17Zm-1 7a1 1 0 0 1 1-1h17a1 1 0 1 1 0 2h-17a1 1 0 0 1-1-1Zm0 6.001a1 1 0 0 1 1-1h17a1 1 0 1 1 0 2h-17a1 1 0 0 1-1-1Z" clip-rule="evenodd" />
            </svg>
            </button>
            <div v-if="showNavigation" class="flex items-center md:hidden bg-black space-y-4 font-medium font-poppins fixed top-0 right-0 w-full z-40 transform translate-y-0 transition-transform duration-300 ml-6 p-2" style="margin-top: 48px;">
